...
###[View Live jezhang Blog &rarr;](http://jezhang.github.io)
...
```
# Site settings
title: Jean's Blog             # title of your website
SEOTitle: Jean's Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: jezhang    # modify this account to yours
weibo_username: jezhang      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-jean.jpg     # use absolute URL.
```
...
```
# Baidu Analytics
ba_track_id: 0ee846e1ba3a25130ad41180a73f6f9a

# Google Analytics
ga_track_id: 'UA-75727255-1'            # Format: UA-xxxxxx-xx
ga_domain: jezhang.github.io
```
...
It's possible that you want the two things different. For me, my site-title is **“Jean's Blog”** but I want the title shows in search engine is **“环紫金山的博客 | Jean's Blog”** which is multi-language.
